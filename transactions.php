...
mysql_select_db($database_supermarket, $supermarket);
$query_report = sprintf("SELECT id, Teller, barcode, product_name, product_price, quantity, total, paid, balance FROM sold WHERE Teller = %s", GetSQLValueString($colname_report, "text"));
$report = mysql_query($query_report, $supermarket) or die(mysql_error());
