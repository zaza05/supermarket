...
$colname_read = "-1";
if (isset($_GET['id'])) {
  $colname_read = $_GET['id'];
}
mysql_select_db($database_supermarket, $supermarket);
$query_read = sprintf("SELECT id, sender_name, receiver_email, `object`, message, `date` FROM messages WHERE id = %s", GetSQLValueString($colname_read, "int"));
$read = mysql_query($query_read, $supermarket) or die(mysql_error());
     ...
     <font size="2"> <table width="831" border="0" align="center">
      <tr>
        ...
        <td width="664"><label for="sender_name"></label>
          <input name="sender_name" type="text" id="sender_name" value="<?php echo $row_read['sender_name']; ?>" size="40" maxlength="40"  border="0"/></td>
      </tr>
      <tr>
        <td><font size="2">Subject</font></td>
        <td><label for="object"></label>
          <input name="object" type="text" id="object" value="<?php echo $row_read['object']; ?>" size="40" maxlength="40" border="0"/></td>
      </tr>
      <tr>
        <td height="132">Message</td>
        <td><label for="message"></label>
          <textarea name="message" id="message" cols="45" rows="20"><?php echo $row_read['message']; ?></textarea></td>
      </tr>
      <tr>
        <td height="132">Date</td>
        <td><label for="date"></label>
          <input name="date" type="text" id="date" value="<?php echo $row_read['date']; ?>" size="40" maxlength="40" border="0" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td><a href="readmessage.php"><input type="button" name="read" id="button" value="INBOX"/></a>&nbsp;&nbsp;
          <a href="sendmessage.php"><input type="button" name="reply" id="button3" value="REPLY" /></a>
          &nbsp;
