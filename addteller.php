...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO teller (teller_id, teller_names, teller_pnumber, teller_email, teller_username, teller_password, teller_location) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['teller_id'], "int"),
...
<div class="container">
  ...
  <div class="content">
    ...
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <table width="961" height="279" border="1">
      <tr>
        <th scope="col">&nbsp;
          <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
            <font size="2">  <table width="633" align="center">
              <tr valign="baseline">
                ...
                <td><input type="text" name="teller_id" value="" size="32" /></td>
              </tr>
              <tr valign="baseline">
                <td nowrap="nowrap" align="left">Teller Names:</td>
                <td><input type="text" name="teller_names" value="" size="32" /></td>
              </tr>
              <tr valign="baseline">
                <td nowrap="nowrap" align="left">Phone Number:</td>
                <td><input type="text" name="teller_pnumber" value="" size="32" /></td>
              </tr>
              <tr valign="baseline">
                <td nowrap="nowrap" align="left">Teller Email:</td>
                <td><input type="text" name="teller_email" value="" size="32" /></td>
              </tr>
              <tr valign="baseline">
                <td nowrap="nowrap" align="left">Telller Username:</td>
                <td><input type="text" name="teller_username" value="" size="32" /></td>
              </tr>
              <tr valign="baseline">
                <td nowrap="nowrap" align="left">Teller Password:</td>
                <td><input type="password" name="teller_password" value="" size="32" /></td>
              </tr>
              <tr valign="baseline">
                <td nowrap="nowrap" align="left">Teller Location:</td>
                <td><input type="text" name="teller_location" value="" size="32" /></td>
              </tr>
              <tr valign="baseline">
                <td nowrap="nowrap" align="left">&nbsp;</td>
                <td><input type="submit" value="ADD TELLER" /></td>
              </tr>
            </table></font>
