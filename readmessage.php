...
$colname_messages = "-1";
if (isset($_SESSION['MM_Username'])) {
  $colname_messages = $_SESSION['MM_Username'];
}
mysql_select_db($database_supermarket, $supermarket);
$query_messages = sprintf("SELECT id, sender_name, receiver_name, sender_email, `object`, message, `date` FROM messages WHERE receiver_name = %s", GetSQLValueString($colname_messages, "text"));
$messages = mysql_query($query_messages, $supermarket) or die(mysql_error());
      ...
      <tr>
        <th scope="col">&nbsp;
         <font size="2"> <table border="0" cellpadding="1" cellspacing="1" align="center">
            <tr bgcolor="#336699">
              <td width="99">ID</td>
              <td width="177">SENDER</td>
              <td width="177">SENDER EMAIL</td>
              <td width="128">SUBJECT</td>
              <td width="116">DATE</td>
              <td width="102">VIEW</td>
            </tr>
            <?php do { ?>
              <tr>
                <td><?php echo $row_messages['id']; ?></td>
                <td><?php echo $row_messages['sender_name']; ?></td>
                <td><?php echo $row_messages['sender_email']; ?></td>
                <td><?php echo $row_messages['object']; ?></td>
                <td><?php echo $row_messages['date']; ?></td>
                <td><a href="read.php?id=<?php echo $row_messages['id']; ?>">View</a></td>
              </tr>
