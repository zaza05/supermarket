...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM teller WHERE id=%s",
                       GetSQLValueString($_GET['id'], "int"));

  mysql_select_db($database_supermarket, $supermarket);
  $Result1 = mysql_query($deleteSQL, $supermarket) or die(mysql_error());

  $deleteGoTo = "deleteteller.php";
...
mysql_select_db($database_supermarket, $supermarket);
$query_rsViewTeller = "SELECT id, teller_id, teller_names, teller_pnumber, teller_email, teller_location FROM teller";
$rsViewTeller = mysql_query($query_rsViewTeller, $supermarket) or die(mysql_error());
$row_rsViewTeller = mysql_fetch_assoc($rsViewTeller);
$totalRows_rsViewTeller = mysql_num_rows($rsViewTeller);
?>
...
<div class="container">
  ...
  <div class="content">
    ...
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <table width="958" height="150" border="1">
      <tr>
        <th scope="col">&nbsp;
         <font size="2"> <table width="932" border="0" align="center" cellpadding="1" cellspacing="1">
           <tr bgcolor="#336699">
              <td width="118">ID</td>
              <td width="162">TELLER ID</td>
              <td width="193">TELLER NAMES</td>
              <td width="208">PHONE NUMBER</td>
              <td width="186">EMAIL</td>
              <td width="202">LOCATION</td>
              <td width="49">DELETE</td>
            </tr>
            <?php do { ?>
              <tr>
                <td><?php echo $row_rsViewTeller['id']; ?></td>
                <td><?php echo $row_rsViewTeller['teller_id']; ?></td>
                <td><?php echo $row_rsViewTeller['teller_names']; ?></td>
                <td><?php echo $row_rsViewTeller['teller_pnumber']; ?></td>
                <td><?php echo $row_rsViewTeller['teller_email']; ?></td>
                <td><?php echo $row_rsViewTeller['teller_location']; ?></td>
                <td><a href="tellerdelete.php?id=<?php echo $row_rsViewTeller['id']; ?>"onclick="return confirm('Are you sure you want to delete')">Delete</a></td>
              </tr>
              <?php } while ($row_rsViewTeller = mysql_fetch_assoc($rsViewTeller)); ?>
          </table>   </font>     </th>
      </tr>
    </table>
  </div>
...
mysql_free_result($rsViewTeller);
?>
