...
mysql_select_db($database_supermarket, $supermarket);
$query_rsDelete = "SELECT * FROM product";
$rsDelete = mysql_query($query_rsDelete, $supermarket) or die(mysql_error());
        ...
        <th scope="col">&nbsp;
         <font size="2"> <table width="932" border="0" align="center" cellpadding="1" cellspacing="1">
            <tr bgcolor="#336699">
              ...
              <td width="170">PRODUCT PRICE</td>
              <td width="173">DATE OF ENTRY</td>
              <td width="131">SUPPLIER</td>
              <td width="119">DELETE</td>
            </tr>
            <?php do { ?>
              <tr>
                <td><?php echo $row_rsDelete['id']; ?></td>
                <td><?php echo $row_rsDelete['product_name']; ?></td>
                <td><?php echo $row_rsDelete['product_price']; ?></td>
                <td><?php echo $row_rsDelete['date_of_entry']; ?></td>
                <td><?php echo $row_rsDelete['supplier']; ?></td>
                <td><a href="delete.php?id=<?php echo $row_rsDelete['id']; ?>"onclick="return confirm('Are you sure you want to delete')">Delete</a></td>
              </tr>
