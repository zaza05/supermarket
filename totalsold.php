...
mysql_select_db($database_supermarket, $supermarket);
$query_Recordset1 = "SELECT id, Teller, barcode, product_name, product_price, quantity, total FROM sold";
$Recordset1 = mysql_query($query_Recordset1, $supermarket) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);

mysql_select_db($database_supermarket, $supermarket);
$query_sum = "SELECT sum(total) FROM sold";
$sum = mysql_query($query_sum, $supermarket) or die(mysql_error());
...
<div class="container">
  ...
  <div class="content">
    <ul id="MenuBar1" class="MenuBarHorizontal">
      ...
      <li><a href="#" class="MenuBarItemSubmenu">Product</a>
        <ul>
          ...
          <li><a href="report.php">sell</a></li>
        </ul>
      </li>
    ...
    <table width="954" border="1">
      ...
      <tr bgcolor="#336699">
        <td width="101">ID</td>
        <td width="123">Teller</td>
        <td width="141">BARCODE</td>
        <td width="181">PRODUCT </td>
        <td width="176">PRICE</td>
        <td width="142">QUANTITY</td>
        <td width="157">TOTAL</td>
      </tr>
      <?php do { ?>
        <tr>
          <td><?php echo $row_Recordset1['id']; ?></td>
          <td><?php echo $row_Recordset1['Teller']; ?></td>
          <td><?php echo $row_Recordset1['barcode']; ?></td>
          <td><?php echo $row_Recordset1['product_name']; ?></td>
   ...
   <p>&nbsp;</p>
    ...
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <table width="355" border="0" align="right">
      <tr>
        <th width="309" scope="col">TOTAL AMOUNT :<?php echo $row_sum['sum(total)']; ?> =/(Ugsh)</th>
      </tr>
    </table>
  </div><br />
