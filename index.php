...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginSuccess = "pointofsale.php";
  $MM_redirectLoginFailed = "failed.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_supermarket, $supermarket);
  
  $LoginRS__query=sprintf("SELECT teller_username, teller_password FROM teller WHERE teller_username=%s AND teller_password= sha1(%s)",
...
if (isset($_POST['username'])) {
  ...
  $LoginRS__query=sprintf("SELECT teller_username, teller_password FROM teller WHERE teller_username=%s AND teller_password=%s",
    GetSQLValueString($loginUsername, "text"), GetSQLValueString($password, "text")); 
...
<div class="container">
  ...
  <div class="content">
    ...
    <div id="apDiv6">
      <p align="center"><font color="#666666">TELLER'S LOGIN PAGE</font> </p>
    </div>
    <!-- end .content --></div>
  <div class="footer">
    <p>[<a href="admin.php"><font color="#666666">Login as administrator</font></a>]</p>
    <!-- end .footer --></div>
<!-- end .container --></div>
</body>
</html>