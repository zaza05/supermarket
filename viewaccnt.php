...
$colname_viewAcc = "-1";
if (isset($_SESSION['MM_Username'])) {
  $colname_viewAcc = $_SESSION['MM_Username'];
}
mysql_select_db($database_supermarket, $supermarket);
$query_viewAcc = sprintf("SELECT id, teller_names, teller_pnumber, teller_email, teller_username, teller_location FROM teller WHERE teller_username = %s", GetSQLValueString($colname_viewAcc, "text"));
...
<div class="container">
  ...
  <div class="content">
    ...
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <table width="956" height="105" border="1">
      <tr>
        <th height="99" scope="col"> <font size="2"> <?php echo $row_viewAcc['id']; ?>
          <table width="914" border="0" align="center" cellpadding="1" cellspacing="1">
          <tr bgcolor="#336699">
            <td>ID</td>
            <td>TELLER NAME</td>
            <td>PHONE NUMBER</td>
          ...
          <?php do { ?>
            <tr>
              <td>20</td>
              <td>Za<font size="2">wadi diane</font></td>
              <td>0786161093</td>
              <td>zawadihailey@gmail.com</td>
              <td>Ndeeba</td>
              <td><a href="accountedit.php?id=<?php echo $row_viewAcc['id']; ?>">Edit</a></td>
            </tr>
            <?php } while ($row_viewAcc = mysql_fetch_assoc($viewAcc)); ?>
        </table></font>
&nbsp;<p>&nbsp;</p></th>
      </tr>
    </table>
