...
mysql_select_db($database_supermarket, $supermarket);
$query_instock = "SELECT id, product_name, product_price, quantity, barcode, made_date, expiring_date, date_of_entry, supplier FROM product";
$instock = mysql_query($query_instock, $supermarket) or die(mysql_error());
$row_instock = mysql_fetch_assoc($instock);
$totalRows_instock = mysql_num_rows($instock);
?>
...
<div class="container">
  ...
  <div class="content">
   ...
   <table width="954" border="1">
      <tr>
        <th scope="col">
          <font size="2"> <table border="0" cellpadding="1" cellspacing="1" align="center">
  <tr bgcolor="#336699">
    <td width="81">ID</td>
    <td width="164">PRODUCT NAME</td>
    <td width="161">PRODUCT PRICE</td>
    <td width="123">QUANTITY</td>
    <td width="122">BARCODE</td>
    <td width="143">MADE DATE</td>
    <td width="161">EXPIRE DATE</td>
    <td width="164">ENTRY SATE</td>
    <td width="152">SUPPLIER</td>
  </tr>
  <?php do { ?>
    <tr>
      <td><?php echo $row_instock['id']; ?></td>
      <td><?php echo $row_instock['product_name']; ?></td>
      <td><?php echo $row_instock['product_price']; ?></td>
      <td><?php echo $row_instock['quantity']; ?></td>
      <td><?php echo $row_instock['barcode']; ?></td>
      <td><?php echo $row_instock['made_date']; ?></td>
      <td><?php echo $row_instock['expiring_date']; ?></td>
      <td><?php echo $row_instock['date_of_entry']; ?></td>
      <td><?php echo $row_instock['supplier']; ?></td>
    </tr>
    <?php } while ($row_instock = mysql_fetch_assoc($instock)); ?>
</table>&nbsp;
</font></th>
      </tr>
    </table>
