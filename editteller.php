...
mysql_select_db($database_supermarket, $supermarket);
$query_rsTellerView = "SELECT * FROM teller";
$rsTellerView = mysql_query($query_rsTellerView, $supermarket) or die(mysql_error());
$row_rsTellerView = mysql_fetch_assoc($rsTellerView);
$totalRows_rsTellerView = mysql_num_rows($rsTellerView);
?>
        ...
        <th scope="col">&nbsp;
         <font size="2"> <table width="932" border="0" align="center" cellpadding="1" cellspacing="1">
           <tr bgcolor="#336699">
            ...
            <?php do { ?>
              <tr>
                <td><?php echo $row_rsTellerView['id']; ?></td>
                <td><?php echo $row_rsTellerView['teller_id']; ?></td>
                <td><?php echo $row_rsTellerView['teller_names']; ?></td>
                <td><?php echo $row_rsTellerView['teller_pnumber']; ?></td>
                <td><?php echo $row_rsTellerView['teller_email']; ?></td>
                <td><?php echo $row_rsTellerView['teller_username']; ?></td>
                <td><?php echo $row_rsTellerView['teller_password']; ?></td>
                <td><?php echo $row_rsTellerView['teller_location']; ?></td>
                <td><a href="editteller2.php?id=<?php echo $row_rsTellerView['id']; ?>">Edit</a></td>
              </tr>
              <?php } while ($row_rsTellerView = mysql_fetch_assoc($rsTellerView)); ?>
          </table>   </font>     </th>
      </tr>
    </table>
  </div>
...
mysql_free_result($rsTellerView);
?>
