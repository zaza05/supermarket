...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE product SET product_name=%s, product_price=%s, barcode=%s, supplier=%s WHERE id=%s",
...
mysql_select_db($database_supermarket, $supermarket);
$query_rsView = sprintf("SELECT id, product_name, product_price, barcode, supplier FROM product WHERE id = %s", GetSQLValueString($colname_rsView, "int"));
$rsView = mysql_query($query_rsView, $supermarket) or die(mysql_error());
...
<div class="container">
  ...
  <div class="content">
    ...
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <table width="960" height="262" border="1">
      <tr>
        <th height="256" scope="col"><form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
            <p>&nbsp;</p>
           <font size="2"> <table width="543" align="center">
              <tr valign="baseline">
                <td width="168" align="left" nowrap="nowrap">Product Name:</td>
                <td width="456"><input type="text" name="product_name" value="<?php echo htmlentities($row_rsView['product_name'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
              </tr>
              <tr valign="baseline">
                <td nowrap="nowrap" align="left">Product Price:</td>
                <td><input type="text" name="product_price" value="<?php echo htmlentities($row_rsView['product_price'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
              </tr>
              <tr valign="baseline">
                <td nowrap="nowrap" align="left">Barcode:</td>
                <td><input type="text" name="barcode" value="<?php echo htmlentities($row_rsView['barcode'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
              </tr>
              <tr valign="baseline">
                <td nowrap="nowrap" align="left">Supplier:</td>
                <td><input type="text" name="supplier" value="<?php echo htmlentities($row_rsView['supplier'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
              </tr>
              <tr valign="baseline">
            ...
            <input type="hidden" name="id" value="<?php echo $row_rsView['id']; ?>" />
        </form></th>
      </tr>
    </table>
  </div>
